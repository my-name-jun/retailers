          ...
          <Tabs>
            <TabPane label="商品介绍">
              ...
              <div class="item-intro-img" ref="itemIntroGoods">
                <userImage width="100%" height="400px" :src="item" v-for="(item,index) in goods.images.split(',')" :key="index" />
              </div>
            </TabPane>
            <TabPane label="售后保障">
            ...
            <TabPane label="商品评价">
              <div class="remarks-container">
                ...
                <div class="remarks-box" v-for="(item,index) in tableData" :key="index">
                  ...
                  <div class="remarks-content-box">
                    <p class="remarks-sub">
                      <span class="remarks-item">{{$Time(item.ids).getTime()}}</span>
                      <span class="remarks-time">{{item.comment}}</span>
                      <userImage width="50" height="52" :src="item.imagePath"  />
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  mounted(){
    this.$api.getComment({goodsId:this.goods.ids},res=>{
